...
class QuizServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        quizRepository = mock(QuizRepository.class); // Correct interface
    ...
    void createQuiz_success() {
        ...
        assertEquals(60, result.getPassingMarks());
    }
    ...
    void getQuizById_notFound() {
        ...
        assertThrows(RuntimeException.class, () ->
                quizService.getQuizById(99L).orElseThrow(() -> new RuntimeException("Not found")));
    }
}
